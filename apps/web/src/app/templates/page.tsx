...
const TEMPLATES = [
    ...
    { id: "25", slug: "tropical-breeze", name: "Tropical Breeze", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?w=400&h=600&fit=crop", usageCount: 1823, desc: "Nhiệt đới xanh mát, tươi mới" },
    { id: "26", slug: "rustic-barn", name: "Rustic Barn", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=400&h=600&fit=crop", usageCount: 1456, desc: "Mộc mạc, ấm àm phong cách đồng quê" },
    { id: "27", slug: "luxury-gold", name: "Luxury Gold", category: "wedding", tier: "premium" as const, thumbnail: "https://images.unsplash.com/photo-1519741497674-611481863552?w=400&h=600&fit=crop", usageCount: 2789, desc: "Vàng đen xa xỉ, đẳng cấp hoàng gia" },
    { id: "28", slug: "sage-garden", name: "Sage Garden", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=400&h=600&fit=crop", usageCount: 987, desc: "Xanh sage nhẹ nhàng, gần gũi thiên nhiên" },
    { id: "29", slug: "dusty-blue", name: "Dusty Blue", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=600&fit=crop", usageCount: 1234, desc: "Xanh dusty nhẹ nhàng, thanh lịch" },
    { id: "30", slug: "burgundy-wine", name: "Burgundy Wine", category: "wedding", tier: "premium" as const, thumbnail: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?w=400&h=600&fit=crop", usageCount: 1567, desc: "Đỏ rượu vang, nồng nàn quyến rũ" },
    { id: "31", slug: "blush-romance", name: "Blush Romance", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1522673607200-164d1b6ce486?w=400&h=600&fit=crop", usageCount: 2345, desc: "Hồng blush ngọt ngào, lãng mạn" },
    { id: "32", slug: "mocha-elegance", name: "Mocha Elegance", category: "wedding", tier: "premium" as const, thumbnail: "https://images.unsplash.com/photo-1595407753234-0882f1e77954?w=400&h=600&fit=crop", usageCount: 876, desc: "Nâu mocha ấm áp, tinh tế cao cấp" },
    { id: "33", slug: "mint-fresh", name: "Mint Fresh", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1520854221256-17451cc331bf?w=400&h=600&fit=crop", usageCount: 1678, desc: "Xanh mint tươi mát, trẻ trung" },
    { id: "34", slug: "rose-gold", name: "Rose Gold Night", category: "wedding", tier: "premium" as const, thumbnail: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=400&h=600&fit=crop", usageCount: 3456, desc: "Đen vàng hồng, sang trọng ban đêm" },
    { id: "35", slug: "do-truyen-thong", name: "Đỏ Truyền Thống", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1587271407850-8d438ca9fdf2?w=400&h=600&fit=crop", usageCount: 4567, desc: "Đỏ truyền thống Á Đông, song hỷ 喜" },
    { id: "36", slug: "peach-garden", name: "Peach Garden", category: "wedding", tier: "basic" as const, thumbnail: "https://images.unsplash.com/photo-1544078751-58fee2d8a03b?w=400&h=600&fit=crop", usageCount: 1890, desc: "Hoa đào vườn xuân, ấm áp" },
];
