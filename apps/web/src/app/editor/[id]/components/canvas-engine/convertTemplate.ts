...
import type { TemplateElement } from "@/server/data/template-presets";

export function convertTemplateToCanvas(
  ...
  return elements.map((te) => {
    ...
    if (te.type === "text") {
      props = {
        ...
        fontFamily:
          (te.props.fontFamily as string) || "'Playfair Display', serif",
        ...
        textAlign: ((te.props.textAlign as string) ||
          "center") as TextProps["textAlign"],
      ...
      props = {
        ...
        objectFit: ((te.props.objectFit as string) ||
          "cover") as ImageProps["objectFit"],
        crop: null,
