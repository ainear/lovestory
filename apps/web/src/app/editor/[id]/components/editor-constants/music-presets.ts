...
// Using free, publicly accessible audio files from reliable CDNs
...
/* ── Music presets — using free Freesound / public domain sources ── */
/* Note: URLs use free-tier CDN from pixabay.com that allows embedding */
